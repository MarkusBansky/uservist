window.swaggerSpec={
  ...
  "tags" : [ {
    ...
    "name" : "Authentication",
    "description" : "Authenticate user with username and password, and the unique identifier of the system. Or validate user token and return user information for that specific service."
  }, {
    "name" : "Invitations",
  ...
  "components" : {
    ...
    "schemas" : {
      ...
      "ServiceRoleDto" : {
        "description" : "Describes an object with service key and a list of roles for this service for a specific user.",
        "type" : "object",
        "required" : [ "userId", "serviceKey", "roles" ],
        "properties" : {
          "service" : {
      ...
      "SessionDto" : {
        "description" : "Describes a unique user logged session object. This is unique to user, service, hardwareId.",
        "type" : "object",
        "required" : [ "user", "service", "hardwareId" ],
        "properties" : {
          "id" : {
            "description" : "Unique identifier.",
            "type" : "integer",
      ...
      "UserServiceInvitationDto" : {
        "description" : "Object being sent to API endpoint to send an email with an invitation link to invite a specific user.",
        "type" : "object",
        "required" : [ "username", "serviceKey" ],
        "properties" : {
          "username" : {
  ...
  "paths" : {
    "/invitations" : {
      "get" : {
        ...
        "tags" : [ "Invitations" ],
        "description" : "User accepts the invitation and acquires role and connection for the specific service.",
        "parameters" : [ {
          "in" : "query",
          "name" : "token",
      ...
      "post" : {
        ...
        "tags" : [ "Invitations" ],
        "description" : "Create an invitation for some user to be added to the service, user would receive a specific role when they approve the invitation. Invitation is sent by email.",
        "requestBody" : {
          "content" : {
            "application/json" : {
              "schema" : {
    ...
    "/services" : {
      ...
      "post" : {
        ...
        "tags" : [ "Services" ],
        "description" : "Creates a new service record in the database. If user does not have a permission to create a record, then trow an error.",
        "requestBody" : {
          "content" : {
            "application/json" : {
              "schema" : {
      ...
      "put" : {
        ...
        "tags" : [ "Services" ],
        "description" : "Updates service record in the database with new information, if such record exists already, if not then error, returns with a key property if user is admin.",
        "requestBody" : {
          "content" : {
            "application/json" : {
              "schema" : {
    ...
    "/users" : {
      "get" : {
        ...
        "tags" : [ "Users" ],
        "description" : "Returns a full list of users available in the system. If user that makes request has enough permissions.",
        "parameters" : [ {
          "in" : "query",
          "name" : "service",
    ...
    "/users/{userId}/permission/{serviceId}" : {
      ...
      "post" : {
        ...
        "tags" : [ "Users" ],
        "description" : "Creates a new user service role that permits user to access specific service depending on their role priveledges.",
        "requestBody" : {
          "content" : {
            "application/json" : {
              "schema" : {
    ...
    "/auth/current" : {
      "get" : {
        ...
        "tags" : [ "Authentication" ],
        "description" : "Get current authenticated user information. Returns user information with user roles for this service.",
        "responses" : {
          "200" : {
    ...
    "/auth/login" : {
      "post" : {
        ...
        "tags" : [ "Authentication" ],
        "description" : "Try to authenticate user with username, password and unique identifier generated based on their machine.",
        "requestBody" : {
          "content" : {
            "application/json" : {
              "schema" : {
